...
export function SlackNode({ data, id }: NodeProps & { data: any }) {
  return (
    <div className="min-w-[240px] font-sans">
      ...
      <NodeWrapper id={id} data={data}>
        ...
        <div className="p-3 text-[12px] text-text-muted flex flex-col gap-2">
           <div className="bg-purple-500/10 border-purple-500/30 p-2 rounded flex items-center justify-center border">
