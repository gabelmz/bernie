...
export function TranslateNode({ data, id }: NodeProps & { data: any }) {
  return (
    <div className="min-w-[240px] font-sans">
      ...
      <NodeWrapper id={id} data={data}>
        <NodeHeader 
          ...
          icon={<Languages className="w-4 h-4 text-text-muted" />} 
          badge="translate"
          backgroundColor={data.backgroundColor}
        />
        <div className="p-3 text-[12px] text-text-muted flex flex-col gap-2">
           <div className="bg-blue-600/10 border-blue-600/30 p-2 rounded flex items-center justify-center border">
